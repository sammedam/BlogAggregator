...
namespace AggregatorContext.Migrations
{
    ...
    [Migration("20200720031753_SeventhMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogDataModel.Commentator", b =>
                {
                    ...
                    b.HasKey("CommentatorID");

                    b.ToTable("commentators");
                });

            modelBuilder.Entity("BlogDataModel.CommentatorComment", b =>
                {
                    b.Property<int>("CommentatorID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CommentatorID", "CommentID");

                    b.HasIndex("commentsCommentID");

                    b.ToTable("CommentatorComments");
                });
            ...
            modelBuilder.Entity("BlogDataModel.Review", b =>
                {
            ...
            modelBuilder.Entity("BlogDataModel.CommentatorComment", b =>
                {
                    b.HasOne("BlogDataModel.Commentator", "Commentators")
                        .WithMany("CommentatorComments")
                        .HasForeignKey("CommentatorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogDataModel.Comments", "comments")
                        .WithMany("CommentatorsComments")
